                    ...
                    <div id="flush-collapse1" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse2" class="accordion-collapse collapse" data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?limit=20">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse3" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?name=st&limit=20">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse4" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?region=africa">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse5" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?countinent=Asia">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse6" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?alphaCode=a">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse7" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?m49Code=24">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse8" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?sort=region,m49Code">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse10" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?limit=10&page=2">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse11" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry?fields=countryName,m49Code">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div id="flush-collapse12" class="accordion-collapse collapse"  data-bs-parent="#worldcountry">
                        <div class="accordion-body py-1">
                            <div class="row text-start">
                                ...
                                <div class="col-3">
                                    <a href="http://www.casedeploy.com/api/v1/worldcountry/62d9a3671b970c63a58b749e">JSON</a>
                                </div>
                            </div> 
                        </div>
                    </div>
