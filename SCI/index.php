            ...
            <div class = "sidesection">
                ...
                <nav>
                    <ul class="navlist">
                        ...
                        <li><a class="buttonlink" href="">Download</a></li>
            ...
            <table  class = "usagetable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="images/Usages/filecontrol.jpg" alt="file_control" style="margin-top:20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="descirption-horizontal">
                                <img src="images/UI/UI_monitor_data.jpg" alt="monitor_data" style="width:50% ;height:50% ; margin-right: 5px;" >
                                <img src="images/UI/UI_monitor_config.jpg" alt="monitor_config" style="width:50% ;height:50%">
                            </div>
                            <div class="descirption-vertical">
                                <div>
